...
CREATE UNIQUE INDEX IF NOT EXISTS kraken_orderbook_btc_usdt_unique_payload
    ON cb.kraken_orderbook_btc_usdt USING btree (exchange_datetime DESC NULLS FIRST, exchange_date DESC NULLS FIRST, bids_hash DESC NULLS FIRST, asks_hash DESC NULLS FIRST)
    TABLESPACE pg_default;