...
public class KrakenOrderBookPersistJmsConsumer extends AbstractJmsConsumer {
    ...
    protected void customProcess(byte[] payload) {
        OrderBookBatch<XchangeKrakenOrderBook> batch = TimeUtils.runTimedCallable_ObjectOutput(() -> SerializationUtils.deserialize(payload), "Deserializing Kraken OrderBook Jms payload");
